...
<div class="dlabnav">
	<div class="dlabnav-scroll">
		...
		<div class="plus-box">
			<p class="fs-14 font-w600 mb-2" style="font-size:0.85rem !important">G Talent Pro<br>Next Gen <?php if ($role == 3) { echo "Placement"; } else {echo "Talent";} ?> Platform<br></p>
		</div>
		<div class="copyright">
			<p><strong>G Talent Pro</strong> © <?php echo date('Y'); ?> All Rights Reserved</p> 
		</div>
	</div>
</div>